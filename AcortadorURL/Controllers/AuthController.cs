    ...
    public class AuthController : ControllerBase
       {
            ...
            public IActionResult Autenticar(AuthRequestBody authRequestBody) //Enviamos como parámetro la clase que creamos arriba
            {
                ...
                var user = _userService.ValidateUser(authRequestBody); //Lo primero que hacemos es llamar a una función que valide los parámetros que enviamos.
                ...
                var securityPassword = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(_config["Auth:SecretForKey"])); //Traemos la SecretKey del Json. agregar antes: using Microsoft.IdentityModel.Tokens;
